...
output: 
  xaringan::moon_reader:
    ...
    includes:
      in_header: scripts/header.html      
    css: scripts/xaringan-themer.css
---
...
![](images/sustainableheat_map.png)
...
You can also use *Rstudio Cloud*. We set up a "classroom" with all necessary packages pre-installed. Here is the invite link:
